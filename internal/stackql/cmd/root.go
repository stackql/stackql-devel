...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&runtimeCtx.NamespaceCfgRaw, dto.NamespaceCfgRawKey, "{}", fmt.Sprintf("JSON / YAML string representing namespaces for cacheing, views etc"))
