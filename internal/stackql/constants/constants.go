...
const (
	...
	ServiceAccountRevokeErrStr         string = `[INFO] Only interactive login credentials can be revoked, to authenticate with a different service account change the keyfilepath in the .stackqlrc file or reauthenticate with a different service account using the AUTH command.`
