...
func (node *TableValuedFuncTableExpr) Accept(vis SQLAstVisitor) error { return vis.Visit(node) }
...
func (node *WindowSpec) Accept(vis SQLAstVisitor) error               { return vis.Visit(node) }
