...
def get_variables(execution_env :str, sql_backend_str :str, use_stackql_preinstalled :str) -> dict:
  ...
  rv = {
    ...
    'SHELL_COMMANDS_AZURE_COMPUTE_MUTATION_GUARD_EXPECTED':                   SELECT_AZURE_COMPUTE_VIRTUAL_MACHINES_EXPECTED + '\n' + SELECT_AZURE_COMPUTE_PUBLIC_KEYS_EXPECTED,
    ...
    'SHELL_SESSION_SIMPLE_EXPECTED':                                          SELECT_GITHUB_BRANCHES_NAMES_DESC_EXPECTED,
