...
PG_PUBLISH_SRV_PORT_DOCKER = 5532
PG_PUBLISH_SRV_PORT_DOCKER_WITH_NAMESPACES = 5533
PG_PUBLISH_SRV_PORT_DOCKER_WITH_EAGER_GC = 5534
PG_PUBLISH_SRV_PORT_DOCKER_UNENCRYPTED = 5535
...
def get_variables(execution_env :str, sql_backend_str :str):
  ...
  rv = {
    ...
    'PG_PUBLISH_SRV_PORT_DOCKER':                     PG_PUBLISH_SRV_PORT_DOCKER,
    'PG_PUBLISH_SRV_PORT_DOCKER_WITH_EAGER_GC':       PG_PUBLISH_SRV_PORT_DOCKER_WITH_EAGER_GC,
    'PG_PUBLISH_SRV_PORT_DOCKER_WITH_NAMESPACES':     PG_PUBLISH_SRV_PORT_DOCKER_WITH_NAMESPACES,
    'PG_PUBLISH_SRV_PORT_DOCKER_UNENCRYPTED':         PG_PUBLISH_SRV_PORT_DOCKER_UNENCRYPTED,
