...
Update Async Returning Simple Projection
    ...
    ...    |-----------|-----------------|
    ${stdErrStr} =    Catenate    SEPARATOR=\n
    ...    compute#operation: patch in progress, 10 seconds elapsed
    ...    compute#operation: patch complete
    Should Stackql Exec Inline Equal Both Streams
    ...    ${STACKQL_EXE}
    ...    ${OKTA_SECRET_STR}
    ...    ${GITHUB_SECRET_STR}
...
Replace Async Returning Simple Projection
    ...
    ...    |-----------|-----------------|
    ${stdErrStr} =    Catenate    SEPARATOR=\n
    ...    compute#operation: update in progress, 10 seconds elapsed
    ...    compute#operation: update complete
    Should Stackql Exec Inline Equal Both Streams
    ...    ${STACKQL_EXE}
    ...    ${OKTA_SECRET_STR}
    ...    ${GITHUB_SECRET_STR}
...
Insert Async Returning Star
    [Documentation]    Insert a row into a table and return all new object values. For synchronously created objects.
    ${inputStr} =    Catenate
    ...    insert /*+ AWAIT */ into google.compute.networks(project, data__name, data__autoCreateSubnetworks) select 'mutable-project', 'auto-test-01', false returning *;
    ${outputStr} =    Catenate    SEPARATOR=\n
    ...    |-----------|-----------------------|-------------------------------|-------------|-------------|------------------|-----------------|------|--------------|----------|----------------------------------------------------------------|---------------------------------------------------------------------------------------------|-------------|
    ...    |${SPACE}IPv4Range${SPACE}|${SPACE}autoCreateSubnetworks${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}creationTimestamp${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}description${SPACE}|${SPACE}gatewayIPv4${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}id${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}kind${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}mtu${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}name${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}peerings${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}routingConfig${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}selfLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}subnetworks${SPACE}|
    ...    |-----------|-----------------------|-------------------------------|-------------|-------------|------------------|-----------------|------|--------------|----------|----------------------------------------------------------------|---------------------------------------------------------------------------------------------|-------------|
    ...    |${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}false${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}2025-07-05T19:42:34.483-07:00${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}1000000000000001${SPACE}|${SPACE}compute#network${SPACE}|${SPACE}null${SPACE}|${SPACE}auto-test-01${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}{"bgpBestPathSelectionMode":"LEGACY","routingMode":"REGIONAL"}${SPACE}|${SPACE}https://www.googleapis.com/compute/v1/projects/mutable-project/global/networks/auto-test-01${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|
    ...    |-----------|-----------------------|-------------------------------|-------------|-------------|------------------|-----------------|------|--------------|----------|----------------------------------------------------------------|---------------------------------------------------------------------------------------------|-------------|
    ${stdErrStr} =    Catenate    SEPARATOR=\n
    ...    compute#operation: insert in progress, 10 seconds elapsed
    ...    compute#operation: insert complete
    ...
    ...    ${outputStr}
    ...    ${stdErrStr}
    ...    stdout=${CURDIR}/tmp/Insert-Async-Returning-Star.tmp
    ...    stderr=${CURDIR}/tmp/Insert-Async-Returning-Star-stderr.tmp

Update Returning Star
    [Documentation]    Update an object and return all new object values. For synchronously updated objects.
    ${inputStr} =    Catenate
    ...    update google.storage.buckets set data__labels = '{ "app_stub": "factory" }' where bucket = 'demo-app-bucket1' returning *;
    ${outputStr} =    Catenate    SEPARATOR=\n
    ...    |------|-----------|---------|------|-----------------------|-----------------------|------------------|------------|------|--------------------------------------------------------------------------------------------------------------------------|------------------|----------------|------------------------|-----------|----------|--------------|---------|----------------|------------------|-------|---------------|-----------------|---------|--------------|----------------------------------------------------------|--------------|--------------------------|--------------------------|------------|---------|
    ...    |${SPACE}acl${SPACE}${SPACE}|${SPACE}autoclass${SPACE}|${SPACE}billing${SPACE}|${SPACE}cors${SPACE}|${SPACE}customPlacementConfig${SPACE}|${SPACE}defaultEventBasedHold${SPACE}|${SPACE}defaultObjectAcl${SPACE}|${SPACE}encryption${SPACE}|${SPACE}etag${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}iamConfiguration${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}id${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}kind${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}labels${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}lifecycle${SPACE}|${SPACE}location${SPACE}|${SPACE}locationType${SPACE}|${SPACE}logging${SPACE}|${SPACE}metageneration${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}name${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}owner${SPACE}|${SPACE}projectNumber${SPACE}|${SPACE}retentionPolicy${SPACE}|${SPACE}${SPACE}${SPACE}rpo${SPACE}${SPACE}${SPACE}|${SPACE}satisfiesPZS${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}selfLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}storageClass${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}timeCreated${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}updated${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}versioning${SPACE}|${SPACE}website${SPACE}|
    ...    |------|-----------|---------|------|-----------------------|-----------------------|------------------|------------|------|--------------------------------------------------------------------------------------------------------------------------|------------------|----------------|------------------------|-----------|----------|--------------|---------|----------------|------------------|-------|---------------|-----------------|---------|--------------|----------------------------------------------------------|--------------|--------------------------|--------------------------|------------|---------|
    ...    |${SPACE}null${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}CAE=${SPACE}|${SPACE}{"bucketPolicyOnly":{"enabled":false},"publicAccessPrevention":"inherited","uniformBucketLevelAccess":{"enabled":false}}${SPACE}|${SPACE}demo-app-bucket1${SPACE}|${SPACE}storage#bucket${SPACE}|${SPACE}{"app_stub":"factory"}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}US${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}multi-region${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}1${SPACE}|${SPACE}demo-app-bucket1${SPACE}|${SPACE}null${SPACE}${SPACE}|${SPACE}${SPACE}100000000001${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}DEFAULT${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}https://www.googleapis.com/storage/v1/b/demo-app-bucket1${SPACE}|${SPACE}STANDARD${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}2025-07-03T00:03:44.250Z${SPACE}|${SPACE}2025-07-03T00:03:44.250Z${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}|
    ...    |------|-----------|---------|------|-----------------------|-----------------------|------------------|------------|------|--------------------------------------------------------------------------------------------------------------------------|------------------|----------------|------------------------|-----------|----------|--------------|---------|----------------|------------------|-------|---------------|-----------------|---------|--------------|----------------------------------------------------------|--------------|--------------------------|--------------------------|------------|---------|
    Should Stackql Exec Inline Equal Both Streams
    ...    ${STACKQL_EXE}
    ...    ${OKTA_SECRET_STR}
    ...
    ...    ${outputStr}
    ...    ${EMPTY}
    ...    stdout=${CURDIR}/tmp/Update-Returning-Star.tmp
    ...    stderr=${CURDIR}/tmp/Update-Returning-Star-stderr.tmp

Update Async Returning Star
    [Documentation]    Replace an object and return all new object values. For asynchronously replaced objects. Also tests selective delayed response return.
    ${inputStr} =    Catenate
    ...    update /*+ AWAIT */ google.compute.firewalls set data__disabled = 'true' 
    ...    where project = 'mutable-project' 
    ...    and firewall = 'updatable-firewall' 
    ...
    ${outputStr} =    Catenate    SEPARATOR=\n
    ...    |------------------------|-------------------------------|--------|-----------------|-------------------|-----------|----------|--------------|------------------|------------------|--------------------|-------------------------------------------------------------------------------------------|----------|----------------------------------------------------------------------------------------------------|---------------|-----------------------|------------|-----------------------|------------|
    ...    |${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}allowed${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}creationTimestamp${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}denied${SPACE}|${SPACE}${SPACE}${SPACE}description${SPACE}${SPACE}${SPACE}|${SPACE}destinationRanges${SPACE}|${SPACE}direction${SPACE}|${SPACE}disabled${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}id${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}kind${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}logConfig${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}name${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}network${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}priority${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}selfLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}sourceRanges${SPACE}${SPACE}|${SPACE}sourceServiceAccounts${SPACE}|${SPACE}sourceTags${SPACE}|${SPACE}targetServiceAccounts${SPACE}|${SPACE}targetTags${SPACE}|
    ...    |------------------------|-------------------------------|--------|-----------------|-------------------|-----------|----------|--------------|------------------|------------------|--------------------|-------------------------------------------------------------------------------------------|----------|----------------------------------------------------------------------------------------------------|---------------|-----------------------|------------|-----------------------|------------|
    ...    |${SPACE}\[{"IPProtocol":"all"}]${SPACE}|${SPACE}2025-07-13T22:08:28.822-07:00${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}|${SPACE}My${SPACE}test${SPACE}fw${SPACE}rule${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}INGRESS${SPACE}${SPACE}${SPACE}|${SPACE}false${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}100000000001${SPACE}|${SPACE}compute#firewall${SPACE}|${SPACE}{"enable":false}${SPACE}|${SPACE}updatable-firewall${SPACE}|${SPACE}https://www.googleapis.com/compute/v1/projects/mutable-project/global/networks/nw-test-02${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}1000${SPACE}|${SPACE}https://www.googleapis.com/compute/v1/projects/mutable-project/global/firewalls/updatable-firewall${SPACE}|${SPACE}\["0.0.0.0/0"]${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|
    ...    |------------------------|-------------------------------|--------|-----------------|-------------------|-----------|----------|--------------|------------------|------------------|--------------------|-------------------------------------------------------------------------------------------|----------|----------------------------------------------------------------------------------------------------|---------------|-----------------------|------------|-----------------------|------------|
    ${stdErrStr} =    Catenate    SEPARATOR=\n
    ...    compute#operation: patch in progress, 10 seconds elapsed
    ...    compute#operation: patch complete
    ...
    ...    ${outputStr}
    ...    ${stdErrStr}
    ...    stdout=${CURDIR}/tmp/Update-Async-Returning-Star.tmp
    ...    stderr=${CURDIR}/tmp/Update-Async-Returning-Star-stderr.tmp

Replace Returning Star
    [Documentation]    Replace an object and return all new object values. For synchronously replaced objects. Also tests selective eager response return.
    ${inputStr} =    Catenate
    ...    replace google.compute.firewalls set data__disabled = 'true' 
    ...    where project = 'mutable-project' 
    ...    and firewall = 'replacable-firewall' 
    ...    returning *;
    ${outputStrNative} =    Catenate    SEPARATOR=\n
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|-----------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|-------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ...    |${SPACE}clientOperationId${SPACE}|${SPACE}creationTimestamp${SPACE}|${SPACE}description${SPACE}|${SPACE}endTime${SPACE}|${SPACE}error${SPACE}|${SPACE}httpErrorMessage${SPACE}|${SPACE}httpErrorStatusCode${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}id${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}insertTime${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}kind${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}name${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}operationGroupId${SPACE}|${SPACE}operationType${SPACE}|${SPACE}progress${SPACE}|${SPACE}region${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}selfLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}startTime${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}status${SPACE}${SPACE}|${SPACE}statusMessage${SPACE}|${SPACE}${SPACE}${SPACE}targetId${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}targetLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}user${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}warnings${SPACE}|${SPACE}zone${SPACE}|
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|-----------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|-------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ...    |${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}1000000000002${SPACE}|${SPACE}2025-07-05T19:42:34.488-07:00${SPACE}|${SPACE}compute#operation${SPACE}|${SPACE}operation-100000000002-10000000002-10000002-10000002${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}update${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}0${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}|${SPACE}https://localhost:1080/compute/v1/projects/mutable-project/global/operations/operation-100000000002-10000000002-10000002-10000002${SPACE}|${SPACE}2025-07-05T19:42:34.491-07:00${SPACE}|${SPACE}RUNNING${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}2000000000002${SPACE}|${SPACE}https://localhost:1080/compute/v1/projects/mutable-project/global/firewalls/replacable-firewall${SPACE}|${SPACE}somejimbo@stackql.io${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}|
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|-----------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|-------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ${outputStrDocker} =    Catenate    SEPARATOR=\n
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|----------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|------------------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ...    |${SPACE}clientOperationId${SPACE}|${SPACE}creationTimestamp${SPACE}|${SPACE}description${SPACE}|${SPACE}endTime${SPACE}|${SPACE}error${SPACE}|${SPACE}httpErrorMessage${SPACE}|${SPACE}httpErrorStatusCode${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}id${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}insertTime${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}kind${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}name${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}operationGroupId${SPACE}|${SPACE}operationType${SPACE}|${SPACE}progress${SPACE}|${SPACE}region${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}selfLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}startTime${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}status${SPACE}${SPACE}|${SPACE}statusMessage${SPACE}|${SPACE}${SPACE}${SPACE}targetId${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}targetLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}user${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}warnings${SPACE}|${SPACE}zone${SPACE}|
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|----------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|------------------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ...    |${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}1000000000002${SPACE}|${SPACE}2025-07-05T19:42:34.488-07:00${SPACE}|${SPACE}compute#operation${SPACE}|${SPACE}operation-100000000002-10000000002-10000002-10000002${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}update${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}0${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}|${SPACE}https://host.docker.internal:1080/compute/v1/projects/mutable-project/global/operations/operation-100000000002-10000000002-10000002-10000002${SPACE}|${SPACE}2025-07-05T19:42:34.491-07:00${SPACE}|${SPACE}RUNNING${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}2000000000002${SPACE}|${SPACE}https://host.docker.internal:1080/compute/v1/projects/mutable-project/global/firewalls/replacable-firewall${SPACE}|${SPACE}somejimbo@stackql.io${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}|
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|----------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|------------------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ${outputStr} =    Set Variable If    "${EXECUTION_PLATFORM}" == "docker"      ${outputStrDocker}    ${outputStrNative}
    Should Stackql Exec Inline Equal Both Streams
    ...    ${STACKQL_EXE}
    ...    ${OKTA_SECRET_STR}
    ...    ${GITHUB_SECRET_STR}
    ...
    ...    ${outputStr}
    ...    ${EMPTY}
    ...    stdout=${CURDIR}/tmp/Replace-Returning-Star.tmp
    ...    stderr=${CURDIR}/tmp/Replace-Returning-Star-stderr.tmp

Replace Async Returning Star
    [Documentation]    Replace an object and return all new object values. For asynchronously replaced objects. Also tests selective delayed response return.
    ${inputStr} =    Catenate
    ...    replace /*+ AWAIT */ google.compute.firewalls set data__disabled = 'true' 
    ...    where project = 'mutable-project' 
    ...
    ${outputStr} =    Catenate    SEPARATOR=\n
    ...    |------------------------|-------------------------------|--------|-----------------|-------------------|-----------|----------|--------------|------------------|------------------|---------------------|-------------------------------------------------------------------------------------------|----------|-----------------------------------------------------------------------------------------------------|---------------|-----------------------|------------|-----------------------|------------|
    ...    |${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}allowed${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}creationTimestamp${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}denied${SPACE}|${SPACE}${SPACE}${SPACE}description${SPACE}${SPACE}${SPACE}|${SPACE}destinationRanges${SPACE}|${SPACE}direction${SPACE}|${SPACE}disabled${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}id${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}kind${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}logConfig${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}name${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}network${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}priority${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}selfLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}sourceRanges${SPACE}${SPACE}|${SPACE}sourceServiceAccounts${SPACE}|${SPACE}sourceTags${SPACE}|${SPACE}targetServiceAccounts${SPACE}|${SPACE}targetTags${SPACE}|
    ...    |------------------------|-------------------------------|--------|-----------------|-------------------|-----------|----------|--------------|------------------|------------------|---------------------|-------------------------------------------------------------------------------------------|----------|-----------------------------------------------------------------------------------------------------|---------------|-----------------------|------------|-----------------------|------------|
    ...    |${SPACE}\[{"IPProtocol":"all"}]${SPACE}|${SPACE}2025-07-13T22:08:28.822-07:00${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}|${SPACE}My${SPACE}test${SPACE}fw${SPACE}rule${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}INGRESS${SPACE}${SPACE}${SPACE}|${SPACE}false${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}100000000001${SPACE}|${SPACE}compute#firewall${SPACE}|${SPACE}{"enable":false}${SPACE}|${SPACE}replacable-firewall${SPACE}|${SPACE}https://www.googleapis.com/compute/v1/projects/mutable-project/global/networks/nw-test-02${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}1000${SPACE}|${SPACE}https://www.googleapis.com/compute/v1/projects/mutable-project/global/firewalls/replacable-firewall${SPACE}|${SPACE}\["0.0.0.0/0"]${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|
    ...    |------------------------|-------------------------------|--------|-----------------|-------------------|-----------|----------|--------------|------------------|------------------|---------------------|-------------------------------------------------------------------------------------------|----------|-----------------------------------------------------------------------------------------------------|---------------|-----------------------|------------|-----------------------|------------|
    ${stdErrStr} =    Catenate    SEPARATOR=\n
    ...    compute#operation: update in progress, 10 seconds elapsed
    ...    compute#operation: update complete
    ...
    ...    ${outputStr}
    ...    ${stdErrStr}
    ...    stdout=${CURDIR}/tmp/Replace-Async-Returning-Star.tmp
    ...    stderr=${CURDIR}/tmp/Replace-Async-Returning-Star-stderr.tmp

Delete Returning Simple Projection
    [Documentation]    Delete an object and return projected system returned object values. For deletion ops that synchronously return some object.
    ${inputStr} =    Catenate
    ...    delete from google.compute.firewalls where project = 'mutable-project' and firewall = 'deletable-firewall' returning kind, user;
    ${outputStr} =    Catenate    SEPARATOR=\n
    ...    |-------------------|----------------------|
...
Delete Returning Star
    ...
    ${inputStr} =    Catenate
    ...    delete from google.compute.firewalls where project = 'mutable-project' and firewall = 'deletable-firewall' returning *;
    ${outputStrNative} =    Catenate    SEPARATOR=\n
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|-----------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ...    |${SPACE}clientOperationId${SPACE}|${SPACE}creationTimestamp${SPACE}|${SPACE}description${SPACE}|${SPACE}endTime${SPACE}|${SPACE}error${SPACE}|${SPACE}httpErrorMessage${SPACE}|${SPACE}httpErrorStatusCode${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}id${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}insertTime${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}kind${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}name${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}operationGroupId${SPACE}|${SPACE}operationType${SPACE}|${SPACE}progress${SPACE}|${SPACE}region${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}selfLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}startTime${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}status${SPACE}${SPACE}|${SPACE}statusMessage${SPACE}|${SPACE}${SPACE}${SPACE}targetId${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}targetLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}user${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}warnings${SPACE}|${SPACE}zone${SPACE}|
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|-----------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ...    |${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}1000000000004${SPACE}|${SPACE}2025-07-05T19:42:34.488-07:00${SPACE}|${SPACE}compute#operation${SPACE}|${SPACE}operation-100000000004-10000000004-10000004-10000004${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}delete${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}0${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}|${SPACE}https://localhost:1080/compute/v1/projects/mutable-project/global/operations/operation-100000000004-10000000004-10000004-10000004${SPACE}|${SPACE}2025-07-05T19:42:34.491-07:00${SPACE}|${SPACE}RUNNING${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}2000000000002${SPACE}|${SPACE}https://localhost:1080/compute/v1/projects/mutable-project/global/firewalls/deletable-firewall${SPACE}|${SPACE}somejimbo@stackql.io${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}|
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|-----------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ${outputStrDocker} =    Catenate    SEPARATOR=\n
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|----------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|-----------------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ...    |${SPACE}clientOperationId${SPACE}|${SPACE}creationTimestamp${SPACE}|${SPACE}description${SPACE}|${SPACE}endTime${SPACE}|${SPACE}error${SPACE}|${SPACE}httpErrorMessage${SPACE}|${SPACE}httpErrorStatusCode${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}id${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}insertTime${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}kind${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}name${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}operationGroupId${SPACE}|${SPACE}operationType${SPACE}|${SPACE}progress${SPACE}|${SPACE}region${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}selfLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}startTime${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}status${SPACE}${SPACE}|${SPACE}statusMessage${SPACE}|${SPACE}${SPACE}${SPACE}targetId${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}targetLink${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}user${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}warnings${SPACE}|${SPACE}zone${SPACE}|
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|----------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|-----------------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ...    |${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}1000000000004${SPACE}|${SPACE}2025-07-05T19:42:34.488-07:00${SPACE}|${SPACE}compute#operation${SPACE}|${SPACE}operation-100000000004-10000000004-10000004-10000004${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}delete${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}0${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}|${SPACE}https://host.docker.internal:1080/compute/v1/projects/mutable-project/global/operations/operation-100000000004-10000000004-10000004-10000004${SPACE}|${SPACE}2025-07-05T19:42:34.491-07:00${SPACE}|${SPACE}RUNNING${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}2000000000002${SPACE}|${SPACE}https://host.docker.internal:1080/compute/v1/projects/mutable-project/global/firewalls/deletable-firewall${SPACE}|${SPACE}somejimbo@stackql.io${SPACE}|${SPACE}null${SPACE}${SPACE}${SPACE}${SPACE}${SPACE}|${SPACE}null${SPACE}|
    ...    |-------------------|-------------------|-------------|---------|-------|------------------|---------------------|---------------|-------------------------------|-------------------|------------------------------------------------------|------------------|---------------|----------|--------|----------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------|---------------|---------------|-----------------------------------------------------------------------------------------------------------|----------------------|----------|------|
    ${outputStr} =    Set Variable If    "${EXECUTION_PLATFORM}" == "docker"      ${outputStrDocker}    ${outputStrNative}
    Should Stackql Exec Inline Equal Both Streams
    ...    ${STACKQL_EXE}
    ...
    ...    ${outputStr}
    ...    ${EMPTY}
    ...    stdout=${CURDIR}/tmp/Delete-Returning-Star.tmp
    ...    stderr=${CURDIR}/tmp/Delete-Returning-Star-stderr.tmp

Delete Await Not Returning Functions as Expected 
    [Documentation]    The silent block and await delete is unaffected by opt-in returning when not opted in.
    ${inputStr} =    Catenate
    ...    delete /*+ AWAIT */ from google.compute.firewalls where project = 'mutable-project' and firewall = 'deletable-firewall';
    ${outputErrStr} =    Catenate    SEPARATOR=\n
    ...    compute#operation: delete in progress, 10 seconds elapsed
    ...
    ...    ${EMPTY}
    ...    ${outputErrStr}
    ...    stdout=${CURDIR}/tmp/Delete-Await-Not-Returning-Functions-as-Expected.tmp
    ...    stderr=${CURDIR}/tmp/Delete-Await-Not-Returning-Functions-as-Expected-stderr.tmp

Delete Await Returning Generates Error
    [Documentation]    The semantics of this fundamentally do not make sense. At this time this is not supported.
    ${inputStr} =    Catenate
    ...    delete /*+ AWAIT */ from google.compute.firewalls where project = 'mutable-project' and firewall = 'deletable-firewall' returning kind, user;
    ${outputErrStr} =    Catenate    SEPARATOR=\n
    ...    returning from asynchronous delete is disallowed
    Should Stackql Exec Inline Equal Both Streams
    ...    ${STACKQL_EXE}
    ...    ${OKTA_SECRET_STR}
    ...    ${GITHUB_SECRET_STR}
