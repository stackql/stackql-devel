...
- [SSL Certificates for GCP load balancers](https://cloud.google.com/load-balancing/docs/ssl-certificates/google-managed-certs).
- [GCP Load Balancer and Managed Instance Groups](https://cloud.google.com/load-balancing/docs/https/setting-up-reg-ext-https-lb).
    - Similar can be achieved with GKE [per zonal NEG doco](https://cloud.google.com/load-balancing/docs/negs/zonal-neg-concepts).
